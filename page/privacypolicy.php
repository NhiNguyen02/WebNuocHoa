    ...
    <div class="container">
        ...
        <div class="content-page">
            <div class="content">
                ...
                <p>Cảm ơn bạn đã truy cập vào trang web HelenePerfume.vn. Chúng tôi tôn trọng và cam kết sẽ bảo mật những thông tin mang tính riêng tư của bạn. Xin vui lòng đọc bản chính sách bảo mật dưới đây để hiểu hơn những cam kết mà chúng tôi thực hiện nhằm tôn trọng và bảo vệ quyền lợi của người truy cập.</p>
                ...
                <ol>
                    <li>
                        ...
                        <p>Chúng tôi sẽ thu thập nhiều thông tin khác nhau của bạn khi bạn muốn đặt hàng trên trang web. Chúng tôi thu thập, lưu trữ và xử lý thông tin của bạn cho quá trình mua hàng, cho những thông báo sau này và để cung cấp dịch vụ. Chúng tôi không giới hạn thông tin cá nhân: danh hiệu, tên, giới tính, ngày sinh, email, địa chỉ, địa chỉ giao hàng, số điện thoại, fax, chi tiết thanh toán, chi tiết thanh toán bằng thẻ hoặc chi tiết tài khoản ngân hàng.</p>
                    ...
                    <li>
                        <strong>Quyền lợi khách hàng</strong>
                        ...
                        <p>Cách Yêu Cầu Xóa Dữ Liệu Cá Nhân Của Bạn:</p>
                        <p>Chúng tôi cam kết tôn trọng quyền riêng tư của bạn và cung cấp cho bạn quyền kiểm soát thông tin cá nhân của mình. Nếu bạn muốn yêu cầu xóa dữ liệu của mình khỏi hồ sơ của chúng tôi, vui lòng tuân theo các bước sau:</p>
                        <ul>
                            <li>Liên Hệ Với Chúng Tôi:
                                <p>Gửi email đến HelenePerfume.com với tiêu đề "Yêu Cầu Xóa Dữ Liệu". Vui lòng sử dụng địa chỉ email liên kết với tài khoản của bạn hoặc cung cấp đủ thông tin để chúng tôi có thể xác định dữ liệu của bạn.</p>
                            </li>
                            <li>Bao Gồm Thông Tin Cần Thiết:
                                <p>Trong email của bạn, bạn cần thể hiện rằng bạn đang yêu cầu xóa dữ liệu cá nhân của mình. Bao gồm tên đầy đủ của bạn, tên người dùng (nếu có), và bất kỳ thông tin khác liên quan nào giúp chúng tôi xác minh danh tính và xác định dữ liệu của bạn trong hệ thống của chúng tôi.</p>
                            </li>
                            <li>Quy Trình Xác Minh:
                                <p>Để bảo vệ quyền riêng tư của bạn và đảm bảo an ninh cho dữ liệu của bạn, chúng tôi có thể cần xác minh danh tính của bạn trước khi xử lý yêu cầu xóa. Điều này có thể bao gồm việc yêu cầu bạn cung cấp thông tin bổ sung hoặc xác nhận một số chi tiết.</p>
                            </li>
                            <li>Xác Nhận Việc Xóa:
                                <p>Khi danh tính của bạn được xác minh, chúng tôi sẽ tiến hành xóa dữ liệu của bạn khỏi hồ sơ của chúng tôi. Chúng tôi sẽ gửi cho bạn một email xác nhận khi quá trình xóa hoàn tất.</p>
                            </li>
                        </ul>
                    </li>
                </ol>
